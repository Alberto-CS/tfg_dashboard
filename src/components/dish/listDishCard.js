...
const listDishCard = ({dish, deleteDish, updateDish}) => {
        ...
        <div>
            <Card className="dishCard">
                ...
                <CardBody>
                    ...
                    <Row className="mt-4">
                        <Button type="button" color="primary" className="mx-auto" id="updateDish" onClick={() => {updateDish(dish.id)}} >Update <MdEdit></MdEdit></Button>
